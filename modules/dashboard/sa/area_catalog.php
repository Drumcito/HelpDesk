...
/* alerts */
$alerts = [];
if (isset($_GET['created'])) $alerts[] = ['type'=>'success','icon'=>'capsulin_add.png','text'=>'ÁREA REGISTRADA'];
if (isset($_GET['updated'])) $alerts[] = ['type'=>'info','icon'=>'capsulin_update.png','text'=>'ÁREA ACTUALIZADA'];
if (isset($_GET['toggled'])) $alerts[] = ['type'=>'info','icon'=>'capsulin_update.png','text'=>'ÁREA ACTUALIZADA'];
...
<main class="user-main sa-panel">
  ...
  <header class="panel-top">
    <div class="panel-top-left">
      ...
      <p class="panel-subtitle">Áreas (Super Admin)</p>
    </div>
  </header>
  ...
  <section class="panel-card">
    <div class="panel-card-head">
      ...
      <div class="directory-actions" style="gap:10px;">
        ...
        <button type="button" class="action-btn action-delete" title="Activar/Desactivar" onclick="toggleArea()">
    ...
    <div class="panel-table-wrap" style="margin-top:12px;">
      <table class="panel-table" id="areasTable">
        <thead>
          <tr>
            <th>ID</th>
            <th>Code (BD)</th>
        ...
        <tbody>
        <?php if(!$rows): ?>
          <tr><td colspan="6" class="panel-empty">No hay áreas.</td></tr>
  ...
  <div class="modal-backdrop" id="modal-create">
    <div class="modal-card">
      ...
      <p class="modal-description">Ejemplos: <b>TI</b>, <b>SAP</b>, <b>MKT</b>.</p>

      <form class="modal-form" method="POST" action="/HelpDesk_EQF/modules/dashboard/sa/area_catalog_actions.php">
        <input type="hidden" name="action" value="create">

        <div class="modal-grid">
          <div class="form-group">
            <label>Code (BD)</label>
            <input type="text" name="code" placeholder="TI" required>
          </div>
          <div class="form-group">
            <label>Etiqueta</label>
            <input type="text" name="label" placeholder="TI" required>
          </div>
          <div class="form-group">
            <label>Orden</label>
  ...
  <div class="modal-backdrop" id="modal-edit">
    <div class="modal-card">
      ...
      <p class="modal-description">Edita el área seleccionada.</p>
  ...
  <!-- FORM TOGGLE (hidden) -->
  <form id="toggleForm" method="POST" action="/HelpDesk_EQF/modules/dashboard/sa/area_catalog_actions.php" style="display:none;">
...
function toggleArea(){
  ...
  const msg = isActive
    ? '¿Desactivar esta área? (no se borra)'
    : '¿Activar esta área?';
